...
void CalibrationInit(Eigen::Matrix4d json_param)
{
  ...
  for (int32_t i = 0; i < 12; i++)
  {
    ...
    rot_tmp               = Eigen::AngleAxisd(transform_flag[0] * cali_scale_degree_ / 180.0 * M_PI, Eigen::Vector3d::UnitX( )) * Eigen::AngleAxisd(transform_flag[1] * cali_scale_degree_ / 180.0 * M_PI, Eigen::Vector3d::UnitY( )) * Eigen::AngleAxisd(transform_flag[2] * cali_scale_degree_ / 180.0 * M_PI, Eigen::Vector3d::UnitZ( ));
                    ...
                    const int &radar_type)
{
  ...
  if (radar_type == 1)
  {
    ...
    } // endwhile: have processed whole file
  }
...
int main(int argc, char **argv)
{
  ...
  pangolin::View &birdview_image = pangolin::Display("birdview")
