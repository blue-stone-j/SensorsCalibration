...
double ICPRegistrator::CalculateICPError(const pcl::KdTreeFLANN<pcl::PointXYZI> &kdtree, const Eigen::Matrix4d &init_guess, float cur_yaw)
{
...
bool ICPRegistrator::RegistrationByICP2(const Eigen::Matrix4d &init_guess, Eigen::Matrix4d &refined_extrinsic)
{
  ...
  computeNormals(tgt_cloud_, cloud_tgt_normal); // (master cloud, )
