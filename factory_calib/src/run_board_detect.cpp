...
int main(int argc, char **argv)
{
  ...
  if (type == 0)
  {
    ...
    LOGI("here");
    sta = corner_detect.CornerDetection(gray_vec, &board_center_point_x, &board_center_point_y,
