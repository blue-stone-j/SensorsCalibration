...
struct InputParam
{
  ...
  float distance_between_two_chessboard; // distance between two chessboard [in meter]
  float chessboard_grid_size;            // size of chessboard grid [in meter]
  float camera_to_board_distance;        // distance between camera and board [in meter]
  float camera_height;                   // camera height [in meter]
  float camera_lateral_offset;           // lateral offset of camera from car center [in meter]
  float camera_vertical_offset;          // vertical offset of camera from car center [in meter]
  float camera_focus_length_fx;          // camera focus length fx
  float camera_focus_length_fy;          // camera focus length fy
