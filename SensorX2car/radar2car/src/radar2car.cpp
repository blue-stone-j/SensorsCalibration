...
double RadarCalibrator::calib(const std::string &radar_file_dir, const std::string &radar_type,
                              const std::string &novatel_enu, const RadarCalibParam &param,
                              bool guessRoughYaw, bool savefig)
{
  // set parameters
