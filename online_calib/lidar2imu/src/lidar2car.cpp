...
void LidarToCar::calib(const std::string &lidar_dir, const std::string &novatel_pose,
                       const std::string &config_dir, const std::string &output_dir,
                       const LidarCalibParam &param)
{
  ...
  {
    // "." and ".." also are treated as two elements in this dir object
...
void LidarToCar::LoadCarPose(const std::string &novatel_pos_path, const Eigen::Matrix4d &gnss2car,
                             const double &start_time, const double &end_time, std::vector<double> &timestamps,
                             std::vector<Eigen::Matrix4d> &car_poses)
{
