...
bool initialExtrinsic::CalibrationExRotation(vector<pair<Vector3d, Vector3d>> corres,
                                             Quaterniond delta_q_imu,
                                             Matrix3d &calib_ric_result)
{
  frameR_count++;
  Eigen::Vector3d Rimu_ypr     = Utility::R2ypr(delta_q_imu.toRotationMatrix( ));
  Eigen::Vector3d Rc_ypr       = Utility::R2ypr(solveRelativeR(corres)); // rotation camera
...
bool initialExtrinsic::CalibrationExPosition(vector<pair<Vector3d, Vector3d>> corres,
                                             Quaterniond delta_q_imu, Vector3d delta_p_imu,
                                             Matrix3d &calib_ric_result, Vector3d &calib_tic_result)
{
  frameRT_count++;
  Eigen::Vector3d Rimu_ypr     = Utility::R2ypr(delta_q_imu.toRotationMatrix( ));
